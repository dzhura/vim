...
syn keyword stateChangeMatch      NULL READY PAUSED PLAYING
syn keyword stateChangeReturnMatch SUCCESS FAILURE ASYNC NO_PREROLL
syn match gstMessagesMatch       '\(ASYNC_DONE\|ASYNC_START\|async-done\|async-start\)'
...
hi stateChangeMatch     ctermfg=63 cterm=bold
hi stateChangeReturnMatch ctermfg=215 cterm=bold
hi gstMessagesMatch ctermfg=154 cterm=bold
